...
def create_board_from_features(
    ...
    if en_passant is not None:
        ...
        if en_passant_file is not None:
            ...
            rank = 5 if side_to_move else 2  # Rank 6 for white, rank 3 for black (0-indexed)
    ...
    try:
        ...
        with np.load(filename) as data:
            ...
            for position_count in range(num_positions):
                ...
                side_to_move = position_count % 2 == 0  # Even positions are white, odd are black
                ...
                print(f"Best Q: Win={q_values[0]:.4f}, Draw={q_values[1]:.4f}, Loss={q_values[2]:.4f}")
